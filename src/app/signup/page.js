const SignupPage = () => {
  return (
    <div className="mt-10">
      <div class="flex w-full max-w-sm mx-auto overflow-hidden bg-[#f4f4f4] rounded-lg shadow-lg dark:bg-gray-800 lg:max-w-4xl">
        ...
        <div class="hidden bg-cover lg:block lg:w-1/2 bg-image"></div>
      </div>
    </div>
  );
};
